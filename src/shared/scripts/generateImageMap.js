...
const iconsDir = path.join(__dirname, '../ui/icons');
const outputFile = path.join(__dirname, '../model/iconCore.tsx');
...
try {
  ...
  const imports = files.map((file) => {
    ...
    return `import ${componentName} from '../ui/icons/${file}?react';`;
  });
  ...
  const content = `import { type ReactElement } from 'react';
